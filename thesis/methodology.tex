...
As can be seen in figure 2\todo{Check whether this number is still correct}, applying a pooling operation is rather straight-forward: for every word vector, the floating point number at every $n$th index is gathered.
...
Each classification will be run 5 times, and the reported score will be the average of those 5 scores, with the aim of reducing as much random effects as possible. 
