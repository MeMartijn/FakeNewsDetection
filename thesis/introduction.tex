...
The ability to broadcast information on a large scale has always been in the hands of large publishing organizations in the pre-Internet era, but nowadays everyone can share news via social media \cite{howell2013}. 
...
Human perception is often skewed with regards to objectivity of facts. 
...
Although fake news classification has been attempted before \cite{wang2018}\cite{khurana2017}, these new pre-trained textual embeddings have not yet been used in the fight against disinformation. 
